package xyz.mathax.client.utils;
...
import xyz.mathax.client.mixininterface.IMinecraftClient;
import xyz.mathax.client.systems.modules.Modules;
import xyz.mathax.client.systems.modules.world.Timer;
import xyz.mathax.client.utils.player.EChestMemory;
import xyz.mathax.client.utils.render.PeekScreen;
import xyz.mathax.client.utils.render.color.Color;
import xyz.mathax.client.utils.world.BlockEntityIterator;
import xyz.mathax.client.utils.world.ChunkIterator;
...
import xyz.mathax.client.mixin.*;
...
public class Utils {
    ...
    public static double getPlayerSpeed() {
        ...
        xyz.mathax.client.systems.modules.world.Timer timer = Modules.get().get(xyz.mathax.client.systems.modules.world.Timer.class);
        if (timer.isEnabled()) {
