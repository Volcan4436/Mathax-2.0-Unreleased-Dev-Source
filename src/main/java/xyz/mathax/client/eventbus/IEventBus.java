package xyz.mathax.client.eventbus;

import xyz.mathax.client.eventbus.listeners.IListener;
import xyz.mathax.client.eventbus.listeners.LambdaListener;
...
public interface IEventBus {
     ...
     * @param packagePrefix Package prefix that this factory will be used for, eg "xyz.mathax.client.eventbus"
