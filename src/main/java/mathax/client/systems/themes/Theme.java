...
import mathax.client.systems.accounts.screens.AccountsScreen;
import mathax.client.systems.modules.misc.screens.NotebotSongsScreen;
import mathax.client.systems.modules.screens.ModuleScreen;
import mathax.client.systems.modules.screens.ModulesScreen;
import mathax.client.systems.proxies.screens.ProxiesScreen;
...
import mathax.client.systems.themes.widgets.*;
import mathax.client.systems.themes.widgets.input.WDropdownTheme;
import mathax.client.systems.themes.widgets.input.WSliderTheme;
import mathax.client.systems.themes.widgets.input.WTextBoxTheme;
import mathax.client.systems.themes.widgets.pressable.*;
import mathax.client.utils.gui.CharFilter;
import mathax.client.utils.gui.SettingsWidgetFactory;
import mathax.client.utils.gui.WindowConfig;
...
public class Theme implements ISerializable<Theme> {
    ...
    public final Setting<SettingColor> plusColorSetting = colorSetting("Plus", "Color of plus button.", new SettingColor(255, 255, 255));

    public final Setting<SettingColor> minusColorSetting = colorSetting("Minus", "Color of minus button.", new SettingColor(255, 255, 255));
    ...
    public final ThreeStateColorSetting backgroundColorSetting = new ThreeStateColorSetting(backgroundColorsSettings, "Background", new SettingColor(Color.MATHAX_BACKGROUND.r, Color.MATHAX_BACKGROUND.g, Color.MATHAX_BACKGROUND.b, 150), new SettingColor(Color.MATHAX.r, Color.MATHAX.g, Color.MATHAX.b, 135), new SettingColor(Color.MATHAX.r, Color.MATHAX.g, Color.MATHAX.b, 175));

    public final Setting<SettingColor> moduleBackgroundSetting = colorSetting(backgroundColorsSettings, "Module background", "Color of module background when enabled.", new SettingColor(Color.MATHAX.r, Color.MATHAX.g, Color.MATHAX.b, 150));
    ...
    public mathax.client.gui.widgets.WLabel label(String text, boolean title, double maxWidth) {
        if (maxWidth == 0) {
